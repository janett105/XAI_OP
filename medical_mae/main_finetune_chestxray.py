...
def get_args_parser():
    ...
    parser.add_argument('--aa', type=str, default='rand-m9-mstd0.5-inc1', metavar='NAME',
                        help='Use AutoAugment policy. "v0" or "original". " + "(default: rand-m6-mstd0.5-inc1)'),
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='models/',
                        help='file directory of model, finetune from checkpoint')
